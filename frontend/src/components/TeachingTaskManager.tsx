...
export default function TeachingTaskManager() {
  ...
  return (
    <>
      <TeachingTaskTable tasks={t.paged} loading={t.loading} search={t.search} onSearchChange={t.setSearch} courseTypeFilter={t.courseTypeFilter} onCourseTypeFilterChange={t.setCourseTypeFilter} taskBatchFilter={t.taskBatchFilter} taskBatchOptions={t.taskBatchOptions} onTaskBatchFilterChange={t.setTaskBatchFilter} page={t.page} pageSize={t.pageSize} total={t.filtered.length} onPageChange={t.setPage} onPageSizeChange={t.setPageSize} deleting={t.deleting} onEdit={t.openDialog} onDelete={t.remove} onAdd={() => t.openDialog()} />
