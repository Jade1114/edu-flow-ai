...
try:
    from python.channels.template_generator import generate_templates
    from python.channels.room_ranker import rank_rooms
    from python.channels.placement_scorer import score_placement, has_hard_conflict
except ImportError:
    import sys
