...
from python.scheduling.assignment_scorer import AssignmentScorer
from python.scheduling.scoring import quality_score
from python.scheduling.selection import deb_tournament_select, elite_select, best_individual
from python.scheduling.teacher_profiles import profile_penalty
from python.scheduling.types import (
...
def tmpl_yield(tmpl_idx: int, ts, task) -> list[int]:
    ...
    from python.scheduling.types import TemplateSet
