...
from ml.scheduling_v2.candidate_pool import (
...
from ml.scheduling_v2.data_loader import is_excluded_course
from ml.scheduling_v2.fitness import evaluate
from ml.scheduling_v2.ga_solver import (
...
from ml.scheduling_v2.models import (
    AssignmentRef,
    ScheduleContext,
    SchedTask,
    TaskCandidate,
...
from ml.scheduling_v2.placement_ranker import _features_for_candidate
from ml.scheduling_v2.pipeline import validate_hard_feasibility
from ml.scheduling_v2.slot_ranker import rank_slots
from ml.training.build_slot_ranker_training_data import _period_start_to_index
