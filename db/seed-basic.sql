...
INSERT INTO allocation_task_generation_config (
    ...
    llm_weight,
    same_day_weight,
    capacity_waste_penalty,
    teacher_day_load_penalty,
    class_day_load_penalty,
...
ON DUPLICATE KEY UPDATE
    ...
    llm_weight = VALUES(llm_weight),
    same_day_weight = VALUES(same_day_weight),
    capacity_waste_penalty = VALUES(capacity_waste_penalty),
    teacher_day_load_penalty = VALUES(teacher_day_load_penalty),
    class_day_load_penalty = VALUES(class_day_load_penalty),
    teacher_overload_penalty = VALUES(teacher_overload_penalty),
